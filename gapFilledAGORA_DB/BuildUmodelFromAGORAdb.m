...
rxnsAttr=struct('lb',model.lb,'ub',model.ub,'rxns',{model.rxns},'subSystems',{model.subSystems},...
    ...
    'rxnMetaNetXID',{model.rxnMetaNetXID},'rxnSEEDID',{model.rxnSEEDID});
...
metsAttr =struct('mets',{model.mets},'metNames',{model.metNames},'metCharges',{model.metCharges},...
    ...
    'metMetaNetXID',{model.metMetaNetXID},'metSEEDID',{model.metSEEDID});
...
Umodel.metMetaNetXID=metsAttr.metMetaNetXID(ord);
Umodel.metSEEDID=metsAttr.metSEEDID(ord);
...
Umodel.rxnMetaNetXID = rxnsAttr.rxnMetaNetXID(ord);
Umodel.rxnSEEDID = rxnsAttr.rxnSEEDID(ord);
...
rxnsAttr.rxnMetaNetXID = [rxnsAttr.rxnMetaNetXID;model.rxnMetaNetXID(rxn_ids)];
rxnsAttr.rxnSEEDID = [rxnsAttr.rxnSEEDID;model.rxnSEEDID(rxn_ids)];
end
...
metsAttr.metMetaNetXID=[metsAttr.metMetaNetXID;model.metMetaNetXID(met_ids)];
metsAttr.metSEEDID=[metsAttr.metSEEDID;model.metSEEDID(met_ids)];
end