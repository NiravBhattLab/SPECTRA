function [ConsModel,LPS,flux] = sprintcore(model,core,tol,gapFilltype,weights,nSol,altSolMethod,probType,solveTime,remGene,prevSols)
% USAGE:
%   [ConsModel,LPS,flux] = sprintcore(model,core,tol,gapFilltype,weights,nSol,altSolMethod,probType,solveTime,remGene,prevSols)
%
% INPUTS:
