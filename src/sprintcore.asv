function [ConsModel,LPS,flux] = sprintcore(model,core,tol,weights,nSol,probType,solveTime,remGene)
% USAGE:
...
%   nSol:      Number of models to build that solves the same obective
%              required (Default: 1)
