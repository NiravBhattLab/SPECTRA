...
for i=1:numel(p)
    ...
    sol = optimizeCbModel(Umodel);
    solutions_univ_model(i,1) = sol.f;
end
save('Results_CheckGrowthSAACmedia')



%%% conclusion: all the models cannot grow in SAAC media. All the universal
%%% model can grow in SAAC media
